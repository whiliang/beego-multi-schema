...
// Usage:
// import(
//   _ "github.com/whiliang/beego-multi-schema/v2/server/web/session/redis_sentinel"
...
import (
	...
	sentinel "github.com/whiliang/beego-multi-schema/v2/server/web/session/redis_sentinel"
)
