...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/whiliang/beego-multi-schema/client/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/whiliang/beego-multi-schema/client/orm.GroupPermissions)"`
}
...
var helpinfo = `need driver and source!
	...
	go get -u github.com/whiliang/beego-multi-schema/client/orm
	...
	go test -v github.com/whiliang/beego-multi-schema/client/orm
	...
	go test -v github.com/whiliang/beego-multi-schema/pgk/orm
